...
class ItemOrdenesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Itemordene::create(['id' => 9,'itemxxxx' => 'Ausencia de partículas', 'rowspanx' => 0, 'colspanx' => 0, 'campoxxx' => 'ausefuga', 'aplicaxx' =>2,'sis_esta_id'=>1,'user_crea_id'=>1,'user_edita_id'=>1]);
        ...
        Itemordene::create(['id' => 12,'itemxxxx' => 'Aucencia de fugas', 'rowspanx' => 0, 'colspanx' => 0, 'campoxxx' => 'fugasxxx', 'aplicaxx' =>2,'sis_esta_id'=>1,'user_crea_id'=>1,'user_edita_id'=>1]);
        Itemordene::create(['id' => 13,'itemxxxx' => 'Aucencia de Miscelas/Integridad emulsión', 'rowspanx' => 0, 'colspanx' => 0, 'campoxxx' => 'miscelas', 'aplicaxx' =>2,'sis_esta_id'=>1,'user_crea_id'=>1,'user_edita_id'=>1]);
        Itemordene::create(['id' => 14,'itemxxxx' => 'Aucencia de burbujas', 'rowspanx' => 0, 'colspanx' => 0, 'campoxxx' => 'burbujas', 'aplicaxx' =>2,'sis_esta_id'=>1,'user_crea_id'=>1,'user_edita_id'=>1]);
        ...
        Itemordene::create(['id' => 16,'itemxxxx' => 'PESO TEÓRICO', 'rowspanx' => 0, 'colspanx' => 0, 'campoxxx' => 'teoricox', 'aplicaxx' =>2,'sis_esta_id'=>1,'user_crea_id'=>1,'user_edita_id'=>1]);
        Itemordene::create(['id' => 17,'itemxxxx' => 'PESO REAL', 'rowspanx' => 0, 'colspanx' => 0, 'campoxxx' => 'realxxxx', 'aplicaxx' =>2,'sis_esta_id'=>1,'user_crea_id'=>1,'user_edita_id'=>1]);
