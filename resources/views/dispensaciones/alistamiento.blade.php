...
<html lang="en">
  <head>
    <title>Dispensaciones(PDF)</title>
  ...
  <body>
    ...
    <div style="border: 1px #000 solid; width: 100%; height: 80px; ">
      ...
      <div class="flotar" style="width: 50%; text-align: center; padding-top: 20px;border-right: 1px #000 solid; height: 60px;">
        DISPESACIÓN DE MEDICAMENTOS Y DIPOSITIVOS MÉDICOS
      </div>
      <div class="flotar" style="width: 20%;text-align: center;">
        ...
        <div style=" padding: 10px 0px 10px 0px;">PRO-FO-10-V0</div>
      </div>
    </div>
    <div style=" width: 100%; padding-top: 10px ">
      <div class="flotar" style="width: 30%;text-align: center;">PRODUCTO</div>
      <div class="flotar" style="width: 25%;text-align: center; border-bottom: 1px #000 solid">{{$data->producto}}</div>
      <div class="flotar" style="width: 10%;text-align: center;">FECHA</div>
      <div class="flotar" style="width: 10%;text-align: center; border-bottom: 1px #000 solid">{{explode(' ', $data->created_at)[0]}}</div>
      <div class="flotar" style="width: 5%;text-align: center;">OP</div>
      <div class="flotar" style="width: 20%;text-align: center; border-bottom: 1px #000 solid">{{$data->ordepres}}</div>
    </div>
