<table style=" width: 100%; border: 1px #000 solid; font-size: 10px"  cellspacing='0' >
  ...
  <tr>     
    <td style="  text-align: left;border-top: 1px #000 solid;border-right: 1px #000 solid;" colspan="2">{{$formulac['lotexxxx']}}</td>
    <td style="  text-align: left;border-top: 1px #000 solid;border-right: 1px #000 solid;" colspan="5">{{$formulac['paciente']['nombrexx']}} </td>
    <td style="  text-align: left;border-top: 1px #000 solid;border-right: 1px #000 solid;" colspan="2">{{$formulac['paciente']['document']}} </td>
    <td style="  text-align: left;border-top: 1px #000 solid;border-right: 1px #000 solid;" colspan="3">{{$formulac['lotexxxx']}}</td>
    <td style="  text-align: left;border-top: 1px #000 solid;" colspan="8">{{$formulac['paciente']['nptxxxxx']}} {{$formulac['medicame']['lipidoxx']}} {{$formulac['medicame']['glutamin']}}</td>
  </tr>
  @endforeach
  <tr>     
