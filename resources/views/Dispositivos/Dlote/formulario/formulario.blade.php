<div class="form-group row">
  <div class="form-group col-md-6">
    ...
    @if($todoxxxx['accionxx'] == 'Ver')
      {{ Form::select('dmarca_id', $todoxxxx['marcaxxx'], $todoxxxx['modeloxx']->dmarca_id, ['class' => 'form-control-plaintext','id'=>'dmarca_id','style'=>"height: 28px"]) }}
    @else
      {{ Form::select('dmarca_id', $todoxxxx['marcaxxx'], null, ['class' => $errors->first('dmarca_id') ? 'form-control is-invalid select2' : 'form-control select2','id'=>'dmarca_id','style'=>"height: 28px"]) }}
    @endif
  ...
  <div class="form-group col-md-6">
    ...
    @if($todoxxxx['accionxx'] == 'Ver')
        {{ Form::text('fechvenc', $todoxxxx['modeloxx']->fechvenc, ['class' => 'form-control-plaintext','style'=>"height: 28px"]) }}
    @else
        {{ Form::text('fechvenc', null, ['class' => $errors->first('fechvenc') ? 'form-control  is-invalid' : 'form-control', 
        'placeholder' => 'Fecha de Vencimiento', 'maxlength' => '120', 'readonly','style'=>"height: 28px"]) }}
    @endif
  ...
  <div class="form-group col-md-6">
    ...
    @if($todoxxxx['accionxx'] == 'Ver')
        {{ Form::text('inventar', $todoxxxx['modeloxx']->inventar, ['class' => 'form-control-plaintext','style'=>"height: 28px"]) }}
    @else
  ...
  <div class="form-group col-md-6">
    ...
    @if($todoxxxx['accionxx'] == 'Ver')
        {{ Form::text('lotexxxx', $todoxxxx['modeloxx']->lotexxxx, ['class' => 'form-control-plaintext','style'=>"height: 28px"]) }}
    @else
        {{ Form::text('lotexxxx', null, ['class' => $errors->first('lotexxxx') ? 'form-control  is-invalid' : 'form-control', 
        'placeholder' => 'Lote', 'maxlength' => '120', 'autofocus','style'=>"height: 28px"]) }}
    @endif
