...
<body>
  ...
  <div style="border: 1px #000 solid; width: 100%; height: 80px; ">
    ...
    <div class="flotar" style="width: 20%;text-align: center;">
      ...
      <div style=" padding: 10px 0px 10px 0px;">PRO-FO-11-V1</div>
    </div>
  </div>
  <div style=" width: 100%; padding-top: 10px ">
    ...
    <div class="flotar" style="width: 10%;text-align: center; border-bottom: 1px #000 solid">
      {{explode(' ', $cabecera->created_at)[0]}}
    </div>
    <div class="flotar" style="width: 5%;text-align: center;">OP</div>
    <div class="flotar" style="width: 20%;text-align: center; border-bottom: 1px #000 solid">{{$cabecera->ordeprod}}</div>
  </div>
  <div style=" width: 100%; padding-top: 40px ">
    <table style=" border: 1px #000 solid" border='1' cellspacing="0">
      @include('Reporte.Control.pdf.cuerpo')
    </table>
  </div>
</body>
</html>
