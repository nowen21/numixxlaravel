...
use App\Models\Produccion\Logs\HControlP;
use Illuminate\Support\Facades\Auth;

class ControlPObserver
{
    ...
    public function created(ControlP $modeloxx)
    {
        HControlP::create($this->getLog($modeloxx));
    }
     ...
     * @return void
     */
    public function updated(ControlP $modeloxx)
    {
        HControlP::create($this->getLog($modeloxx));
    }

    /**
     * Handle the ControlP "deleted" event.
     *
     * @param  \App\Models\Medicamentos\Unidad\ControlP  $modeloxx
     * @return void
     */
    public function deleted(ControlP $modeloxx)
    {
        HControlP::create($this->getLog($modeloxx));
    }

    /**
     * Handle the ControlP "restored" event.
     *
     * @param  \App\Models\Medicamentos\Unidad\ControlP  $modeloxx
     * @return void
     */
    public function restored(ControlP $modeloxx)
    {
        HControlP::create($this->getLog($modeloxx));
    }

    /**
     * Handle the ControlP "force deleted" event.
     *
     * @param  \App\Models\Medicamentos\Unidad\ControlP  $modeloxx
     * @return void
     */
    public function forceDeleted(ControlP $modeloxx)
    {
        HControlP::create($this->getLog($modeloxx));
    }
}
