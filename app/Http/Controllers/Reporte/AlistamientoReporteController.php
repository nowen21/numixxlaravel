...
class AlistamientoReporteController extends Controller
{
    use ProduccionTrait;
    use InventarioTrait;
    ...
    {
        $this->opciones['permisox'] = 'alistami';
        ...
        $this->opciones['tituhead'] = 'ALISTAMIENTO';
        $this->opciones['routxxxx'] = 'alistami';
        $this->opciones['slotxxxx'] = 'alistami';
