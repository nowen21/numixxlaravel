...
use App\Http\Requests\Dispositivos\DinvimaCrearRequest;
use App\Http\Requests\Dispositivos\DinvimaEditarRequest;
...
class DinvimaController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->opciones['rutaxxxx'] = 'dinvima';
        $this->opciones['routnuev'] = 'dinvima';
        $this->opciones['routxxxx'] = 'dinvima';
        ...
        $this->opciones['tablasxx'] = [
            [
                ...
                'columnsx' => [
                    ...
                    ['data' => 'id', 'name' => 'dinvimas.id'],
                    ['data' => 'reginvim', 'name' => 'dinvimas.reginvim'],
                    ['data' => 's_estado', 'name' => 'sis_estas.s_estado'],
                ],
                'tablaxxx' => 'tabladinvima',
                'permisox' => 'dinvima',
                'routxxxx' => 'dinvima',
                'parametr' => [$padrexxx],
            ],
    ...
    {
        $this->opciones['marcaxxx'] = Dmarca::combo(['medicame' => $this->opciones['padrexxx'], 
     ...
     * @return \Illuminate\Http\Response
     */
    public function store($padrexxx, DinvimaCrearRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function show($padrexxx, Dinvima $objetoxx)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit($padrexxx, Dinvima $objetoxx)
    {
    ...
    {
        $padrexxx = dinvima::transaccion($dataxxxx, $objectx);
        return redirect()
            ->route($this->opciones['routxxxx'] . '.editar', [$padrexxx->mmarca->medicame_id, $padrexxx->id])
            ->with('info', $infoxxxx);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update($padrexxx, DinvimaEditarRequest $request, dinvima $objetoxx)
    {
        $dataxxxx = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Dinvima $objetoxx)
    {
