...
class MnptEditarRequest extends FormRequest
{
  private $_mensaje;
    private $_reglasx;
  ...
  public function validar() {
      ...
      $mnptxxx=Mnpt::where("randesde", $this->randesde)->where("ranhasta", $this->ranhasta)->
      where("medicame_id", $this->segments()[1])->whereNotIn("id", [$this->segments()[3]])->
      first();
