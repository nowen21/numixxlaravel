...
use App\Casa;
use App\Helpers\Aminoacidos;
use App\Helpers\Fosfatos;
use App\Helpers\Carbohidratos;
use App\Helpers\Sodios;
use App\Helpers\Potasios;
use App\Helpers\Calcios;
use App\Helpers\Magnesios;
use App\Helpers\ElementosTrazas;
use App\Helpers\MultivitaminasHidrosolubles;
use App\Helpers\MultivitaminasLiposolubles;
use App\Helpers\Glutaminas;
use App\Helpers\VitaminasC;
use App\Helpers\ComplejosB;
use App\Helpers\Tiaminas;
use App\Helpers\Acidos;
use App\Helpers\VitaminasK;
use App\Helpers\Lipidos;
use App\Helpers\Aguas;
...
class CasasFormulacion {
  ...
  public function __construct($dataxxxx) {
    ...
    foreach ($casasxxx as $key => $casa) {
      $medicame = [];
      foreach ($casa->medicamentos as $key => $medicamento) {
        $medicame[$medicamento->id] = $this->estructura();
      }
  ...
  public function calculos($dataxxxx) {
    $medicame = \App\Medicamento::where('id', $dataxxxx['medisele'])->first();
    $calculox=[];
