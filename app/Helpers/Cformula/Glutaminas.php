...
class Glutaminas {
  ...
  private function requemientodiarionpt() {
    ...
    switch ($this->npt_idxx) {
      case 1: // pediatricos
        $formulax[19] = $this->dataxxxx['volumenx'] / 5 / $this->pesoxxxx;
        break;
      case 2: // neonatos
        $formulax[19] = $this->dataxxxx['volumenx'] / 5 / $this->pesoxxxx;
        break;
  ...
  private function requemientototalnpt() {
    ...
    switch ($this->npt_idxx) {
      case 1:// pediatricos
        $formulax[19] = $this->pesoxxxx * $this->dataxxxx['requdiar'];
        break;
      case 2:// neonatos
        $formulax[19] = $this->pesoxxxx * $this->dataxxxx['requdiar'];
        break;
  ...
  private function purganpt() {
    ...
    switch ($this->npt_idxx) {
      case 1:// pediatricos
        $formulax[19] =  $this->purgaxxx * $this->estructu[$this->casaxxxx][$this->medicame]['volumenx'] ;
        break;
      case 2:// neonatos        
        $formulax[19] =  $this->purgaxxx * $this->estructu[$this->casaxxxx][$this->medicame]['volumenx'] ;
        break;
  ...
  private function volumennpt() {
    ...
    switch ($this->npt_idxx) {
      case 1:// pediatricos
        $formulax[19] = $this->estructu[$this->casaxxxx][$this->medicame]['reqtotal'] * 5;
        break;
      case 2:// neonatos
        $formulax[19] = $this->estructu[$this->casaxxxx][$this->medicame]['reqtotal'] * 5;
        break;
